...
public abstract class AbstactEmailService implements EmailService {
    ...
    public void sendOrderConfirmationHtmlEmail(Pedido obj){
        try{
            MimeMessage mm = prepareMimeMessageFromPedido(obj); //tenta mandar o html normal
            sendHtmlEmail(mm);
        }
        catch (MessagingException e){
            sendOrderConfirmationEmail(obj); //se nao manda o toText
        }
    }
